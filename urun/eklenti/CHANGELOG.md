...
- **Ölçüt dosya yolundan değil, iki beyandan türüyor.** Genel ya da tümü kapsamlı bir kural hiçbir tipi adıyla anmaz ve anlamı yönettiği iş düğümleridir; tipi şemada Yasa rolünde olan bir düğüm ise, yani Karar, Politika, Kural, Anayasa, Mevzuat ve kural tipleri, yükün kaynağıdır. Bu yüzden joker kapsamlı bir kural Yasa rolündeki düğüme yük olarak düşmüyor. Bir Kararı adıyla, ailesiyle ya da koduyla açıkça hedefleyen kural ise düşmeye ve sayılmaya devam ediyor. Kanonun metnine, madde sayısına, dosyalara bölünüşüne ve yirmilik eşiğe dokunulmadı.
- **Kullanıcı projesindeki gerçek taşma görünür kalıyor.** Yirmi bir genel kural taşıyan bir dosyada Blok ve Adım düğümleri uyarı almaya devam ediyor, yanlarındaki Karar susuyor ve yirmi kuralda kalan düğüm sessiz kalıyor. Mevcut eşik nöbetleri değiştirilmeden yeşildir.
- **Panel kartı ile uyarı aynı hükmü veriyor.** Yol Haritası kartındaki bağlı kurallar listesi ile koni taşması sayımı artık aynı yük predikatından ve aynı şema evreninden besleniyor; bir Karar düğümünün kartı da ona düşmeyen genel yasayı saymıyor. Yapısal koşulların değerlendirilmesi eski kapsam çözümünü kullanmayı sürdürüyor, çünkü bu değişiklik yalnız bağlam yükünün sayıldığı evreni düzeltir.
- **Ölçüm ve kanıt.** Sarmal'ın kendi kökünden koşan denetim sekiz uyarıdan sıfır hata ve sıfır uyarıya indi. Beş yeni nöbet kuruldu ve dört ayrı mutasyonun dördü de beklenen nöbetleri kırmızıya düşürdü: düzeltmenin sökülmesi, joker yükün her yerde susturulması, panel listesinin eski predikata döndürülmesi ve çapraz rol beyanının okunmaması.

## 0.9.181 — 2026-09-11 (dosya mühürleri: arşiv, eğitim ve sonraya bırakılan iş adıyla ayrılıyor)

- **Bir dosyanın canlı kaynak olmadığını artık adı söylüyor.** Dosya adının başına yazılan bir mühür, `@ARSIV@_`, `@EGITIM@_` ya da `@SONRA@_`, dosyanın işi bitmiş tarih mi, ders örneği mi, sonraya bırakılmış iş mi olduğunu bildiriyor. Arşiv ve sonra mühürlü dosyalar graf, karne ve tanı sayımının dışında kalıyor; eğitim mühürlü dosya okunup doğrulanıyor, fakat karneye girmiyor. Kural kanonda MIM-3.4 maddesi olarak yaşıyor ve eskiden klasör adından tahmin yürüten örtük muafiyetin yerine dosyanın sahibinin açık beyanını koyuyor.
- **Mühür hiçbir zaman sessiz değil.** Her denetim mühürlü dosyaları türüyle ve adıyla listeliyor, sonraya bırakılmış dosya kaç gündür beklediğiyle Hatırlatıcılar panelinde görünüyor ve yeni mühürlenen dosya kancada o anda bildiriliyor. Ebedî kural taşıyan bir dosya arşiv mührü alamıyor, çünkü ebedî kuralı graftan çıkarmak onu silmek demek; mühürsüz bir dosya adında büyük harf ya da tanınmayan bir mühür uyarı üretiyor.
- **Biçim ölçümle seçildi.** Köşeli parantez kabukta desen hatası verdi, diyez işareti kabukta yorum sayılıp komutun anlamını sessizce değiştirdi; `@` işareti ise zsh ve bash kabuklarında ve git ile `.gitignore` deseninde tırnaksız çalıştı.

## 0.9.180 — 2026-09-11 (çatı kökünden tek denetim, her proje kendi hanesinde)

- **Çatı artık altındaki projeleri sahipleniyor.** Bir çalışma alanının ilan ettiği kitaplığın altında yaşayan her Proje kökü grafta o çalışma alanının altına bağlanıyor; bugüne kadar projeler çatının altında değil yanında öksüz duruyordu. Gerçek çatıda üç proje kökü de çalışma alanı düğümüne bağlandı ve tek projeli bir deponun grafı bayt bayt aynı kaldı.
- **Aynı şablondan doğan projeler birbirini yutmuyor.** Kardeş projeler aynı kitaplık ve raf kodlarını taşıdığında her kod kendi Projesinin altında ayrı bir düğüm olarak yaşıyor; kodlara önek eklenmiyor, ayrım yalnız birleştirme anında yapılıyor. Gezinme, etki ve arama araçları aynı adı birden çok projede bulduğunda hepsini projesiyle birlikte gösteriyor ve sessizce birini seçmiyor.
- **Çatı kökünden koşan denetim her projeyi kendi kökünden ölçüyor.** Meyve yolu, ebedî kilit ve disk mutabakatı artık bulgunun sahibi olan projenin kökünden çözülüyor ve bulgular Proje koduyla ayrı hanelerde toplanıyor. Ölçüm: Sarmal'ın hanesi çatı kökünden üç yüz altmış beş hatadan sıfıra indi ve kendi kökünden okunan tabloyla birebir aynı hâle geldi. Bedeli, çatı kökünden koşumun yaklaşık yüzde yetmiş uzamasıdır.
- **Mühürlü mevsimin açık iş taşıması artık görünüyor.** Metninde mühürlendiğini ya da işini devrettiğini yazan bir mevsim hâlâ açık Adım sarıyorsa yeni bir gözlem bunu bildiriyor; ölçüt metnin iddiası değil grafın sayısıdır ve gözlem hiçbir kapıyı kırmızıya düşürmüyor.

## 0.9.179 — 2026-09-10 (yeni ağaç kademe kademe doğuyor, tanı panele ulaşıyor)

- **Doğuş paketi artık kapısız bir kök bırakmıyor.** Founder yeni bir Sarmal ağacını kurarken ajanın acele edip yanıldığını bildirdi ve aynı çatı iki kez kurulup iki kez silindi. Ölçüm kusurun yerini gösterdi: paket bir proje için altı, bir çalışma alanı için sekiz dosya yazıyordu ve doğan kökte ne yürütücü ayarı, ne kanca, ne MCP kaydı, ne de yok sayma istisnası vardı; yani ağaç doğduğu anda hiçbir kapının arkasında değildi ve ilk yanlış hamleyi hiçbir şey durdurmuyordu. Paket bugün proje için on üç, çalışma alanı için yirmi iki dosya yazıyor. Yeni gelenler şunlardır: yok sayma istisnası, MCP sunucu kaydı, yürütücü yönergesinin bayt özdeş ikizi, yürütücü ayarı ile iki kanca betiği ve tip kanonu işaretçisi.
- **Doğan ağacın hafızası artık depoya giriyor.** Kullanıcı düzeyindeki küresel yok sayma kuralı `*.sar` desenini taşıyabilir ve o makinede doğan bir projenin bütün planı sessizce izlenmeden kalır. Doğuş paketi bu yüzden depo kuralına üç satırlık istisna yazıyor. Gerçek bir git deposunda ölçüldü: doğan beş `.sar` dosyasının beşi de izleniyor, hiçbiri yok sayılmıyor; var olan bir yok sayma dosyasının kendi satırları olduğu gibi korunuyor ve istisna tam bir kez yazılıyor. Ölçümün yapıldığı makinenin küresel yok sayma dosyası `.sar` desenini gerçekten taşımaktadır, yani istisna kuramsal bir önlem değildir.
- **Kitaplık kademesi doğuşta da, öğretimde de zorunlu.** Dallanan her klasör bir Kitaplıktır ve raflar Kitaplıkların içinde yaşar; kökün altına çıplak raf dizilmez, çünkü ağaç büyüdükçe giriş dosyası okunamaz bir raf listesine döner. Paket bu kademeyi kendi ürettiği ilanda uyguluyor, karşılama kartı örneğinde gösteriyor ve beyansız yapı tanısının çözüm satırı artık Raf değil Kitaplık öneriyor.
- **Planlama artık yavaş olduğunu kendi ağzıyla söylüyor.** Doğuş rehberi üç yeni bölüm kazandı. Birincisi Sarmal'ın ne için var olduğunu anlatır: motor kod değil niyet üretir ve hedef, uzun ömürlü ve karar yoğun bir işi insan ile ajanın birlikte yürütebilmesidir. İkincisi ağacın tek hamlede değil kademe kademe kurulduğunu, her kademenin ayrı bir insan onayı durağı olduğunu ve üst kademe onaylanmadan alt kademenin yazılmadığını bildirir. Üçüncüsü planlamanın yavaş olduğunu söyler: mimari önce konuşulur, her kademede somut seçenekler sunulur ve belirsizlik görüldüğünde varsayım değil soru üretilir. Rehbere ayrıca gerçek koşumlarda kaydedilmiş beş anti-desen indi; hiçbiri varsayım değildir, her biri ölçülmüş bir yanılgıdır.
- **Öğretim kapısı boş dizinde de cevap veriyor.** Bir ağaç henüz doğmadan sorulan "çalışma alanı nedir" ya da "teknoloji nasıl ilan edilir" sorusu eskiden cevapsız kalıyordu, oysa asıl yardıma o anda ihtiyaç vardır. Öğretim kapısı artık boş dizinde de koşuyor ve konu kartının tam metnini döndürüyor; beş ayrı yazım denendi ve beşi de aynı kartı getirdi.
- **Zaman ekseni projeye bağlandı.** Bir Faz hangi Projenin mevsimi olduğunu bugüne kadar grafta söylemiyordu; kimlik normalleştirmesi tek eve alındı ve graf bu kenarı gördü. Ölçüm: proje kökünden çözülen graf otuz üç düğümden yedi yüzün üzerine çıktı. Düzeltmeden önce gelen otuz üç düğümün tamamı Kitaplık, Raf, Teknoloji ve Sınıflama idi; ne bir Faz, ne bir Blok, ne bir Adım geliyordu. Bugün aynı kök yedi yüz dört düğüm döndürmekte ve içinde beş Faz, yirmi sekiz Blok ile dört yüz on üç Adım görünmektedir. Aynı düzeltme çalışma alanı çatısının Faz içeremeyeceği hükmünü de zorlar hâle getirdi.
- **Panelin körlüğü kapandı: tanı üreten hiçbir yol artık insandan gizli değil.** Founder bir uyarının panelde görünmediğini bildirdi ve kusur ölçüldü: motorun tanı üreticilerinden yalnız yirmi ikisi panele ulaşıyordu, hata ya da uyarı üretip panele hiç ulaşamayan otuz üretici vardı. Panel bugün elli iki üreticiden besleniyor ve panele ulaşamayan hata/uyarı üreticisi sayısı sıfırdır. Bu depoda panele düşen tanı sayısı birden elli ikiye çıktı. Maliyet değişmedi, çünkü denetim o üreticileri iki hâlde de zaten koşturuyordu; panele taşınan şey yeni bir hesap değil, var olan hesabın görünür kılınmasıdır. Yalnız komut satırında kalan dokuz girdinin dokuzu da bilgi düzeyinde konuşmakta ve her biri neden orada kaldığını yazılı gerekçesiyle bildirmektedir. Mutasyonla kanıtlandı: panelin atıf kaynağı söküldüğünde on beş nöbetin altısı kırmızı yandı, geri alındığında on beşi de yeşile döndü.
- **Çapraz proje atıfları artık kardeş kökleri gerçekten görüyor.** Kardeş kök okuyucusu yalnız Raf kademesini tarıyordu, dolayısıyla Kitaplık hükmünden sonra doğan her çatıya yapısal olarak kördü. Gezinme aracı üç durumlu hâle geldi ve kapalı depoda ölçülen çapraz atıf hatası on birden üçe indi.
- **Terfi kapısı ölçümü üretim yoluna bağlandı ve hiçbir tanının düzeyi yükseltilmedi.** Sekiz ayrışan tanı kimliklendirildi ve üç sütun yan yana kayda indi: kanonun öngördüğü düzey, bugünkü kademe ve canlı bulgu sayısı. Sayılar motorun kendi tür dökümünden bağımsız olarak doğrulandı ve birebir tuttu. Terfi yapılmadı, çünkü kanıtsız terfi yasaktır ve üç tanı hâlâ canlı bulgu taşımaktadır; kararı bulgu sayısı verir, iddia değil.
- **Öğretim yüzeyleri artık var olmayan bir rafı adres göstermiyor.** Doğuş paketi öğrenme kartlarını öğreti kitaplığının içindeki öğrenme rafına yazmaktadır, buna karşılık karşılama kartı, yönerge ikizi, rehber üreteci, beceri kartı başlığı ile öğretim aracının açıklaması kartların kökün hemen altındaki çıplak bir rafta yaşadığını söylüyordu; yani kartı okuyan ajan var olmayan bir yol öğreniyordu. Aynı kusurun ikizi tasarım sözlüğünde bulundu ve o da kitaplık önekiyle tazelendi. Bir üçüncü kalem, prizma aracının Türkçe hanesinin dört yüzden yalnız üçünü sayması, İngilizce haneyle eşitlendi. Sızıntının bugüne kadar yaşamasının sebebi de kapandı: bayat adresi ölçen nöbet yalnız tek bir yolu arıyordu ve üç satırlık bir nöbet ailesine çevrildi. Aile kendi doğruluğunu da ölçmektedir, çünkü hiçbir şey yakalamayan bir desen de yeşil kalırdı; altı mutasyonun altısı da beklenen nöbeti kırmızıya düşürdü.

- **Belge yüzleri doğan ağacın gerçek adresini gösteriyor.** İki kök belgesindeki çalışma ağacı çizimi bugünkü on üç dosyalık pakete göre yeniden yazıldı, Kitaplık kademesi anlatıya girdi ve örnekteki plan dosyası artık gerçekte doğduğu yerde gösteriliyor. Belgedeki sayısal iddialar da yeniden ölçüldü: tanı sayısı yüz yetmiş beş, kanon madde sayısı yüz on dokuz, örnek projenin karnesi yirmi düğüm ile üç Adımdır. Bir tanı alıntısının satır ve sütun numarası gerçek koşumla düzeltildi.
