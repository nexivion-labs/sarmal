...
const KANON_SHA = [
  ...
  "ork.sar:d45d023d706304bf0b4e38bd63d2cedb093cd512f027d00215459794b0791aac",
...
test("70 taban + iki gözlem kümesi 46/16/10 olarak 72'dir", () => {
  assert.equal(YENI_TANI_KANONU.length, 72);
  ...
  assert.equal(YENI_TANI_KANONU.filter((t) => t.kademe === "bilgi").length, 10);
...
test("A03 türevi idempotenttir ve geneldurum'u hüküm kaynağı olarak okumaz", () => {
  ...
  assert.match(ilk, /69 yeni tanı tabanı YUZ-3\.3 tanısıyla ve iki gözlemle 72/);
