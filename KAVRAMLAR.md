...
|---|---|---|
| Kanonik hüküm | `yasa/kanon/` içindeki sekiz dosya | `161` madde; metin burada yinelenmez |
| Tip, alan, enum ve sarma | `oz/siniflama/kayit.json` | [tam Reference tablosu](oz/siniflama/kayit.md) |
| Tanı kimliği ve düzeyi | `urun/cekirdek/src/tani-sicili.ts` | 47 hata · 17 uyarı · 14 bilgi |
