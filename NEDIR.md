...
Bu giriş elle korunur; kavramsal açıklama kanonik omurgadan üretilir.
<!-- SARMAL:ELLE-KORUNAN:SON -->

<!-- SARMAL:URETILEN:KOK-NEDIR:BAS -->
<!-- SARMAL:DIATAXIS Explanation -->
## Niyetin çalışan haritası
...
Kanon 156 maddelik sekiz bölümden oluşur ve yalnız `yasa/kanon/` altında yaşar. Katı üretim omurgası `ÇalışmaAlanı → Auth → Proje[*] → Faz → Blok → Katman → AltKatman → Adım → üretir → Meyve → dosya` zinciridir. Esnek rejim bilinçli bir istisnadır; gerekçesi açık yazılır.
